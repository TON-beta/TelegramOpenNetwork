...
// ton includes.
#include <..\src\script\tonconsensus.h>
...
int main()
{
    std::cout << "tonconsensus version: " << tonconsensus_version() << std::endl;
    ...
    auto op0Result = tonconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, tonconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
