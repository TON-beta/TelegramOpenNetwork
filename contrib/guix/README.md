# Bootstrappable ton Core Builds

This directory contains the files necessary to perform bootstrappable ton
Core builds.
...
- 24GB of free disk space on the partition that the ton Core git repository
  resides in
...
For a ton Core depends development environment, simply invoke
...
From the top of a clean ton Core repository:
...
To use dongcarl's substitute server for ton Core builds after having
