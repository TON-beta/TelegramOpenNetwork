...
(define* (make-ton-cross-toolchain target
                                  #:key
...
desirable for building ton Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-ton-cross-toolchain "i686-linux-gnu")
       (make-ton-cross-toolchain "x86_64-linux-gnu")
       (make-ton-cross-toolchain "aarch64-linux-gnu")
       (make-ton-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-ton-cross-toolchain "riscv64-linux-gnu"
