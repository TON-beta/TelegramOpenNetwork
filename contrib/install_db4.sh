...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the ton repository."
  exit 1
fi
...
# See https://github.com/ton/ton/issues/16064
...
echo 'When compiling tond, run `./configure` in the following way:'
echo
