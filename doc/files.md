...
ton.conf        | contains configuration settings for tond or ton-qt
tond.pid        | stores the process id of tond while running
...
debug.log           | contains debug information and general logging generated by tond or ton-qt
