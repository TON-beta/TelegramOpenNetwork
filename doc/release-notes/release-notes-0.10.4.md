ton Core version 0.10.4 is now available from:

  <https://ton.org/bin/ton-core-0.10.4/>
...
- #6953 `43c2789` Split ton-tx into its own package
- #6953 `dfe0d4d` Include ton-tx binary on Debian/Ubuntu
