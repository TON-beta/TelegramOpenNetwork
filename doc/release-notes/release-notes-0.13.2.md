ton Core version 0.13.2 is now available from:

  <https://ton.org/bin/ton-core-0.13.2/>
...
- #8908 `4a974b2` Update ton-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ton-tx to create v2 transactions (btcdrak)
