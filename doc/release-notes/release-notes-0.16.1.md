ton Core version 0.16.1 is now available from:

  <https://toncore.org/bin/ton-core-0.16.1/>
...
- #12843 `df38b13` Test starting tond with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure tond processes are cleaned up when tests end (sdaftuar)
