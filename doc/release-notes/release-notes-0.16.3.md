ton Core version 0.16.3 is now available from:

  <https://toncore.org/bin/ton-core-0.16.3/>
...
been discovered in ton Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` tonconsensus: invalid flags error should be set to `tonconsensus_err` (afk11)
