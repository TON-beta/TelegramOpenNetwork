ton version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ton/files/ton/ton-0.5.4/
...
http://gitorious.org/ton/tond-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix ton-Qt notifications under Growl 1.3.
Increase required age of ton-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxton properly when installing ton-Qt over it. (Windows)
