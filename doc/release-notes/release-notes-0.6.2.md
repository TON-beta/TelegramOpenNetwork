ton version 0.6.2 is now available for download at:
http://sourceforge.net/projects/ton/files/ton/ton-0.6.2/
...
Fixed https://github.com/ton/ton/issues/1065, a bug that
