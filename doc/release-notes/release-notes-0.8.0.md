ton-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ton/files/ton/ton-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the ton
...
New/changed settings (command-line or ton.conf file)
--------------------------------------------------------
