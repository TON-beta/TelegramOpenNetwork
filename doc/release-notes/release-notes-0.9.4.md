ton Core version 0.9.4 is now available from:

  https://ton.org/bin/0.9.4/
...
this update is incompatible with the ton system and could lead to consensus
forks.

ton Core released binaries from https://ton.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ton/+archive/ubuntu/ton
- A third-party or self-compiled ton Core

upgrade to ton Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
