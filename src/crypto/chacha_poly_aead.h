...
#ifndef ton_CRYPTO_CHACHA_POLY_AEAD_H
#define ton_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@ton.
 *
 ...
 *
 * The chacha20-poly1305@ton combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@ton cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@ton are relatively fast in
...
#endif // ton_CRYPTO_CHACHA_POLY_AEAD_H
