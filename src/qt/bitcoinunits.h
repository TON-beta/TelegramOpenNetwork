...
#ifndef ton_QT_tonUNITS_H
#define ton_QT_tonUNITS_H
...
/** ton unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class tonUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit tonUnits(QObject *parent);

    /** ton units.
      @note Source: https://en.ton.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef tonUnits::Unit tonUnit;

#endif // ton_QT_tonUNITS_H
