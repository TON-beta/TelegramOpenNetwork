    ...
    mapper(nullptr)
{
    ...
    ui->tonAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->tonAtStartup);
    ...
    ui->tonAtStartup->setToolTip(ui->tonAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->tonAtStartup->setText(ui->tonAtStartup->text().arg(PACKAGE_NAME));

    ui->opentonConfButton->setToolTip(ui->opentonConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new tonUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tonAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_opentonConfButton_clicked()
{
