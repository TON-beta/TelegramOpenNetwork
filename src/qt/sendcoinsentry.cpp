    ...
    platformStyle(_platformStyle)
{
    ...
    // normal ton address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying ton address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &tonAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
