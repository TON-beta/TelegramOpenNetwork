...
//! Entry point for tonApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &tonApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for tonGUI tests.
void AppTests::guiTests(tonGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &tonGUI::consoleShown, this, &AppTests::consoleTests);
