...
#ifndef ton_SCRIPT_STANDARD_H
#define ton_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a ton address
 */
...
/**
 * Generate a ton scriptPubKey for the given CTxDestination. Returns a P2PKH
