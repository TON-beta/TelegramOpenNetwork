// Copyright (c) 2012-2019 The ton Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.toncore.org", "www.toncore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.toncore.org]", "www.toncore.org", -1));
    BOOST_CHECK(TestSplitHost("www.toncore.org:80", "www.toncore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.toncore.org]:80", "www.toncore.org", 80));
