...
#ifndef ton_TEST_SCRIPTNUM10_H
#define ton_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from ton Core 0.10.0, for cross-comparison.
 */
public:
