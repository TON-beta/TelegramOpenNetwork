// Copyright (c) 2010-2018 The ton Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ton_UTIL_ERROR_H
#define ton_UTIL_ERROR_H
 ...
 *
 * Error types defined here can be used in different parts of the ton
