...
#ifndef ton_WALLET_WALLET_H
#define ton_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! ton from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The ton Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this ton node, and set to 0 for transactions that were created
