...
"""Verify that starting ton with -h works as expected."""

from test_framework.test_framework import tonTestFramework
from test_framework.util import assert_equal

class HelpTest(tonTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ton with -h for help text")
        ...
        self.log.info("Start ton with -version for version information")
        ...
        self.log.info("Start tond with -fakearg to make sure it does not start")
