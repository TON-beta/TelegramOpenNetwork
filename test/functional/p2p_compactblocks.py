#!/usr/bin/env python3
# Copyright (c) 2016-2019 The ton Core developers
...
# TestP2PConn: A peer we use to send messages to tond, and store responses.
...
class CompactBlocksTest(tonTestFramework):
    ...
    # This test actually causes tond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that tond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for tond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # tond will not send blocktxn responses for blocks whose height is
